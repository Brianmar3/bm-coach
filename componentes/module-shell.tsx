...
export function ModuleShell({
  ...
  return (
    <main className={`min-h-screen bg-zinc-950 px-6 pb-6 text-white md:px-10 md:pb-10 ${flushTop ? "pt-6 md:pt-8" : "pt-6 md:pt-10"}`}>
      <div className="mx-auto max-w-7xl">
        {!hideHeader && <header className="mb-8 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
