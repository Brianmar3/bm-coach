...
function PointsHistoryPageView({ data }: { data: PortalData }) {
  return <div className="mx-auto w-full max-w-3xl overflow-x-clip px-0.5 sm:px-0">
    ...
    <header className="portal-points-enter mt-6 [--points-delay:0ms]"><p className="text-[10px] font-black uppercase tracking-[.22em] text-yellow-400">Historial</p><h1 className="mt-1 text-2xl font-black tracking-tight text-zinc-100 sm:text-3xl">Movimientos de puntos</h1><p className="mt-1 text-sm text-zinc-500">Consultá cómo sumaste tus puntos.</p></header>
