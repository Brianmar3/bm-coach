...
function WorkoutAreaIcon({ area }: { area: WorkoutArea }) {
  ...
  if (area === "lower") return <svg viewBox="0 0 32 32" className={common} fill="none"><path d="M11 5c0 6 1 10 3 13l-2 9m9-22c0 6-1 10-3 13l2 9M12 14h8" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" /></svg>;
  ...
  return <svg viewBox="0 0 32 32" className={common} fill="none"><circle cx="16" cy="16" r="10" stroke="currentColor" strokeWidth="2" /><circle cx="16" cy="16" r="4" stroke="currentColor" strokeWidth="2" /><path d="M16 3v4m0 18v4M3 16h4m18 0h4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" /></svg>;
}
