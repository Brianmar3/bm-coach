  ...
  return <div className="portal-home-sequence mx-auto max-w-5xl space-y-2.5 sm:space-y-3">
    <header className="portal-home-enter portal-home-hero relative overflow-hidden rounded-[24px] border border-white/[.07] bg-[radial-gradient(circle_at_88%_8%,rgba(250,204,21,.045),transparent_28%),linear-gradient(145deg,#151515,#090909_70%)] p-4 shadow-[0_18px_45px_rgba(0,0,0,.34)] sm:p-5">
      ...
      <div className={`relative min-h-28 sm:min-h-32 ${groupClassesEnabled && !routineFocused ? "pr-[5.4rem] sm:pr-28" : ""}`}>
        <p className="flex items-center gap-2 text-[11px] text-zinc-500"><BmCalendarIcon size={16} className="shrink-0 text-yellow-400" />{todayLabel}</p>
  ...
  return <>
    ...
    <section className="relative mb-5 overflow-hidden rounded-3xl border border-yellow-400/20 bg-[radial-gradient(circle_at_10%_10%,rgba(250,204,21,.11),transparent_34%),linear-gradient(145deg,#1b1b1b,#0a0a0a)] p-4 shadow-[0_18px_42px_rgba(0,0,0,.34)]">
      ...
      <div className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3 pt-7">
        <span className="grid h-12 w-12 place-items-center rounded-2xl border border-yellow-400/20 bg-yellow-400/[.04] text-yellow-300"><BmBarbellIcon size={24} /></span>
