...
function ProgressSkeleton() { return <div aria-label="Cargando progreso" className="mx-auto max-w-5xl animate-pulse space-y-5"><div className="h-12 w-64 rounded-2xl bg-zinc-900" /><div className="h-64 rounded-[26px] bg-zinc-900" /><div className="grid grid-cols-2 gap-3 lg:grid-cols-4">{Array.from({ length: 4 }, (_, index) => <div key={index} className="h-28 rounded-2xl bg-zinc-900" />)}</div><div className="h-72 rounded-[22px] bg-zinc-900" /></div>; }
