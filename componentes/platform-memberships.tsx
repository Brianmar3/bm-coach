...
export function PlatformMemberships({ trainers, initialFilter = "ALL" }: { trainers: MembershipTrainer[]; initialFilter?: Filter }) {
  ...
  return <>
    ...
    {managing && <TrainerMembershipManager trainer={managing} subscription={managing.subscription} onClose={() => setManaging(null)} onSaved={async () => { setManaging(null); router.refresh(); }} />}
  </>;
}
