...
export function ProfessionalEvaluationsDashboard() {
  ...
  return <ModuleShell title="Evaluaciones" subtitle="Alumnos personalizados y mixtos">
    ...
    {editor && <EvaluationWizard initial={editor} baseUrl={`/api/admin/alumnos/${editor.studentId}/evaluaciones`} profileHeight={0} birthDate={student?.birthDate ?? ""} onClose={() => void closeEditor()} />}
