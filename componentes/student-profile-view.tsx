...
function SettingsMenu({ onClose }: { onClose: () => void }) {
  ...
  const links = [["Seguridad", "/portal/configuracion#seguridad", "♧"], ["Privacidad", "/portal/configuracion#privacidad", "▣"], ["Preferencias", "/portal/configuracion#preferencias", "☷"], ["Ayuda", "/portal/comentarios", "?"]] as const;
