...
export default async function SelfServiceRoutinePage() {
  ...
  if (await hasActivePortalRoutine(studentId, workspaceId)) return <SelfServiceShell student={student}><PortalSection section="rutina" dataEndpoint="/api/portal/autogestion/rutina" selfService /></SelfServiceShell>;
