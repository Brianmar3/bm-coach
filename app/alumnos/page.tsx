...
export default function AlumnosPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!form.plan || !form.joinedAt || !form.scheduleId) { setError("Seleccioná plan, fecha de inicio y horario o grupo."); return; }
