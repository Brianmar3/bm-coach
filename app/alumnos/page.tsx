...
export default function AlumnosPage() {
    ...
    {open && <><StudentForm form={form} setForm={setForm} options={options} error={error} notice={notice} close={() => setOpen(false)} submit={submit} editing={Boolean(editing)} saving={saving}/><ScheduleMultiPicker form={form} setForm={setForm} schedules={options.schedules}/></>}
