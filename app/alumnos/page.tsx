...
function blank(options: EnrollmentOptions, previous?: Pick<StudentFormValue, "plan" | "joinedAt" | "status" | "studentType" | "serviceType" | "responsibleName" | "responsiblePhone" | "responsibleRelation">): StudentFormValue {
...
export default function AlumnosPage() {
    ...
    async function submit(event: FormEvent<HTMLFormElement>) {
        ...
        if (!form.plan || !form.joinedAt || !form.serviceType) {
