...
function ConditioningExerciseEditor({ exercise, update, changeTarget, move, remove }: { exercise: ExerciseDraft; update: <K extends keyof ExerciseDraft>(key: K, value: ExerciseDraft[K]) => void; changeTarget: (targetType: ExerciseDraft["targetType"]) => void; move: (direction: -1 | 1) => void; remove: () => void }) {
