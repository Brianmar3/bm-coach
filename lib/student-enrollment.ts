...
export function serializeStudent(record: StudentWithSchedule): Student {
  ...
  return {
    ...
    onboardingCompletedAt: typeof stored.onboardingCompletedAt === "string" ? stored.onboardingCompletedAt : "",
    trainingExperience: stored.trainingExperience === "Principiante" || stored.trainingExperience === "Intermedio" || stored.trainingExperience === "Avanzado" ? stored.trainingExperience : undefined,
    hasLimitations: typeof stored.hasLimitations === "boolean" ? stored.hasLimitations : undefined,
    limitations: typeof stored.limitations === "string" ? stored.limitations : "",
    onboardingObservations: typeof stored.onboardingObservations === "string" ? stored.onboardingObservations : "",
    id: record.id,
